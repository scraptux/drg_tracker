  ...
  <div class="bg-white">
    <div v-if="loading==0 && !error" class="pt-6">
      ...
      <div class="mx-auto max-w-7xl space-x-2 py-5 sm:px-6 lg:px-3 border-y mb-4 border-gray-200">
        <dl>
          <router-link :to="`/ops/version/${year}/code/${kode.Code}`"
            ...
            <dt class="text-sm my-auto font-medium text-gray-500">{{ kode.Code }}</dt>
            <dd class="text-sm my-auto text-gray-900 col-span-8">{{ kode.Titel }}</dd>
